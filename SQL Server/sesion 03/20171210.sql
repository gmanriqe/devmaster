...
-- 7. Elabore la consulta base para el paginado de peliculas:
	...
	-- descendente. Asi sucesivamente para las demas pestañas 
...
-- WHERE nombrepais LIKE '_u%i_' --Segunda letra es una �u� y pen�ltima la �i� (HABLANDO DE POSICIONES ESPECIFICAS)
-- WHERE nombrepais LIKE '_u%[^i]__' -- Segunda letra es una �u� y antepen�ltima diferente a �i�
-- WHERE nombrepais LIKE '_u%[^io]__'-- Segunda letra es una �u� y antepen�ltima diferente a �i� o diferente a "o"
-- WHERE nombrepais LIKE '_u%[^i]__' -- Contenga una �a� seguida del car�cter sombrero, seguida de la letra �b�
...
-- uso del CROSS JOIN
--1. Liste todas las combinaciones de categor�as de pel�culas y planes.
...
--2. Liste por cada pel�cula el nombre, resumen, a�o de estreno, duraci�n en
...
-- 3. Liste por cada calificaci�n la valoraci�n, fecha de valoraci�n, comentario,
...
-- 4. Liste por cada usuario el alias, correo, estado y nombre de su pa�s. NOTA: Los usuarios deben mostrarse as� el pa�s no se encuentra cargado
...
--5. Liste por cada pa�s el id, nombre del pa�s, as� como el alias y correo de los
--usuarios asociados.
